        ...
        return ApplicationRunner {
            CoroutineScope(Dispatchers.Default).launch {
                if (memberService.findByUserid("system") == null) {
                    memberService.join("system", "시스템관리자", "system@example.com", "1234", "defaultImageType", defaultImageBytes, "")
                    memberService.join("admin", "관리자", "admin@example.com", "1234", "defaultImageType", defaultImageBytes, "")
                }
            }
        }
    }
